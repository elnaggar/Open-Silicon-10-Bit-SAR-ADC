# Timing constraints for sar_logic -- Chipathon 2026 (gf180mcu, hardened macro)
...
# synthesis, PnR, and signoff enforce the SAME limit -- mismatched values make
# violation reports ambiguous).
# KNOWN WAIVER: the FSM state-decode net (fanout53, 21 loads) exceeds both this
# fanout limit and the 1.5 ns max-transition below. Functionally benign at the
# 12.5 MHz operating point; root cause is a synthesis mapping, not these limits.
